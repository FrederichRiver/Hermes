...
from data_engine.mysql_meta import resolve_stock_connection
...
class DatabaseEngine:
    ...
    def connect(self):
        ...
        connection_config = resolve_stock_connection()
        self.cfg.user = connection_config["user"]
        self.cfg.password = connection_config["password"]
        self.cfg.database = connection_config["db"]
        try:
